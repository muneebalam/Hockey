...
def get_gamesheet_folder(season):
    ...
    return '/Users/Me/Desktop/NHL/Raw/{0:d}{1:d}/'.format(season, season + 1)
...
def get_parsed_gamesheet_folder(season):
    ...
    return '/Users/Me/Desktop/NHL/Parsed/{0:d}{1:d}/'.format(season, season + 1)
...
def get_teamlist(season):
    exclude_teams = {'EAS', 'WES', 'ASB', 'ASR', 'BLU', 'RED'}
    if season >= 2014:
        exclude_teams.add('PHX')
    else:
        exclude_teams.add('ARI')
    if season >= 2011:
        exclude_teams.add('ATL')
    else:
